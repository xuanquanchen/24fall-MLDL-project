...
class UnetPlusPlus(nn.Module):
    def __init__(self, num_classes, deep_supervision=False):
        ...
        self.stage_0 = ContinusParalleConv(3, self.filters[0], pre_Batch_Norm = False)
        self.stage_1 = ContinusParalleConv(self.filters[0], self.filters[1], pre_Batch_Norm = False)
        self.stage_2 = ContinusParalleConv(self.filters[1], self.filters[2], pre_Batch_Norm = False)
        self.stage_3 = ContinusParalleConv(self.filters[2], self.filters[3], pre_Batch_Norm = False)
        self.stage_4 = ContinusParalleConv(self.filters[3], self.filters[4], pre_Batch_Norm = False)
